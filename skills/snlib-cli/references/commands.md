...
./scripts/snlib-cli hope-book-request \
  --request-edn '{:title "도서명" :author "저자" :publisher "출판사" :publishYear "2025" :eaIsbn "9788966264896" :price "54000" :email "user@example.com" :smsReceiptYn "Y" :handPhone "010-3764-0262"}' \
  --submit --allow-submit --pretty
```
