...
(def ^:private cli-options
  [[nil "--base-url URL" (str "SNLib base URL (default: " default-cli-base-url ")")]
   ...
   [nil "--apl-lib-code CODE" "Applicant library code (6-digit numeric, see resource snlib/lib-code.edn)"]
...
(def ^:private command-help
  {"login"
   ...
   "hope-book-request"
   ["--manage-code CODE (optional; recommended)"
...
(defn- usage
  ...
  (str "snlib CLI\n\n"
       ...
       "  snlib interloan-request --manage-code MA --reg-no CEM000050087 --apl-lib-code 141484\n"
       "  snlib hope-book-request --manage-code MU --request-edn '{:title \"도서명\" :author \"저자\" :handPhone \"010-1234-5678\" :email \"user@example.com\"}'\n"
       "  snlib my-info\n"
